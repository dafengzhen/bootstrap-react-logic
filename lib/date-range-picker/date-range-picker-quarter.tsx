...
import type { DateRangePickerQuarterProps } from './types.ts';
...
const DateRangePickerQuarter = function DatePickerQuarter<T extends ElementType = 'div'>(
  props: DateRangePickerQuarterProps<T>,
) {
  const {
  ...
  const [calendarData, setCalendarData] = useState(
    generateCalendar(currentYear, currentMonth, [], 6, 1, undefined, selectedDate, locale, false, 'quarter'),
  );
...
DateRangePickerQuarter.displayName = 'BRL.DateRangePickerQuarter';

export default DateRangePickerQuarter;
