...
import type { DateRangePickerYearProps } from './types.ts';
...
const DateRangePickerYear = function DatePickerYear<T extends ElementType = 'div'>(props: DateRangePickerYearProps<T>) {
  const {
  ...
  const [calendarData, setCalendarData] = useState(
    generateCalendar(currentYear, currentMonth, [], 6, 1, undefined, selectedDate, locale, false, 'year'),
  );
...
DateRangePickerYear.displayName = 'BRL.DateRangePickerYear';

export default DateRangePickerYear;
