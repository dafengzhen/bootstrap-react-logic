...
import type { DatePickerYearProps } from './types.ts';
...
const DatePickerYear = function DatePickerYear<T extends ElementType = 'div'>(props: DatePickerYearProps<T>) {
  const {
...
DatePickerYear.displayName = 'BRL.DatePickerYear';
