...
import type { DatePickerQuarterProps } from './types.ts';
...
const DatePickerQuarter = function DatePickerQuarter<T extends ElementType = 'div'>(props: DatePickerQuarterProps<T>) {
  const {
...
DatePickerQuarter.displayName = 'BRL.DatePickerQuarter';

export default DatePickerQuarter;
