...
export type OmittedPropsWithoutRef<
  P,
  T extends ElementType,
  V extends object,
  O extends keyof any,
> = P & Omit<Omit<ComponentProps<T>, O>, keyof BaseProps<T, V>>;

export type OmittedPropsWithRef<
  P,
  T extends ElementType,
  V extends object,
  O extends keyof any,
> = P & Omit<Omit<ComponentPropsWithRef<T>, O>, keyof BaseProps<T, V>>;

export type OmittedPropsWithAs<
  P,
  T extends ElementType,
  V extends object,
  O extends keyof any,
> = P & (OmittedPropsWithoutRef<P, T, V, O> | OmittedPropsWithRef<P, T, V, O>);
